...
template <typename T, typename LabelT = uint32_t> class PQFlashIndex
{
  public:
    ...
    DISKANN_DLLEXPORT void cached_beam_search(const T *query, const uint64_t k_search, const uint64_t l_search,
                                              ...
                                              std::vector<int>* cnt_stats = nullptr, std::vector<float>* time_stats = nullptr);
    ...
    DISKANN_DLLEXPORT void cached_beam_search(const T *query, const uint64_t k_search, const uint64_t l_search,
                                              ...
                                              QueryStats *stats = nullptr, std::vector<int>* cnt_stats = nullptr, std::vector<float>* time_stats = nullptr);
    ...
    std::unique_ptr<uint32_t[]> starling = nullptr;
